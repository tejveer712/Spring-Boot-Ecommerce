...
public class Address {
    ...
    @NotBlank
    @Size(min = 2, message = "State name must be atleast 2 charachters")
    private String state;

    @NotBlank
    @Size(min = 2, message = "Country name must be atleast 2 charachters")
    private String country;

    @NotBlank
    @Size(min = 6, message = "Pincode must be atleast 6 charachters")
